...
ifneq ($(wildcard vendor/lineage-priv/keys/verifiedboot.pem),)
BOARD_AVB_KEY_PATH := vendor/lineage-priv/keys/verifiedboot.pem
BOARD_AVB_ALGORITHM := SHA256_RSA4096

BOARD_AVB_BOOT_KEY_PATH := vendor/lineage-priv/keys/verifiedboot.pem
BOARD_AVB_BOOT_ALGORITHM := SHA256_RSA4096
BOARD_AVB_RECOVERY_KEY_PATH := vendor/lineage-priv/keys/verifiedboot.pem
BOARD_AVB_RECOVERY_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/lineage-priv/keys/verifiedboot.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_VENDOR_KEY_PATH := vendor/lineage-priv/keys/verifiedboot.pem
