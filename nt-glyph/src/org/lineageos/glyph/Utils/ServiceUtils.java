...
import org.lineageos.glyph.Services.TorchService;
...
public final class ServiceUtils {
    ...
    private static void startTorchService() {
        context.startServiceAsUser(new Intent(context, TorchService.class), UserHandle.CURRENT);
    }

    private static void stopTorchService() {
        context.stopServiceAsUser(new Intent(context, TorchService.class), UserHandle.CURRENT);
    }
